...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animator2scaleX = ObjectAnimator.ofFloat(target,
                "scaleX",1,2);
        ObjectAnimator animator2scaleY = ObjectAnimator.ofFloat(target,
                "scaleY",1,2);
        animator2scaleX.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        animator2scaleX.setRepeatCount(ObjectAnimator.INFINITE);
        animator2scaleX.setRepeatMode(ObjectAnimator.REVERSE);
        animator2scaleY.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        animator2scaleY.setRepeatCount(ObjectAnimator.INFINITE);
        animator2scaleY.setRepeatMode(ObjectAnimator.REVERSE);
        ...
        animatorSet.playTogether(animator1,animator2scaleX,animator2scaleY,animator3);
        animatorSet.start();
    }
}
